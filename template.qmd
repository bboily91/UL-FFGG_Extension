...
# Section a revoir si edite avec RStudio
jupyter: ~/code/autogis/bin/python3
---
...
``` {python}
#| label: tlb-pandas
#| tbl-cap: Tableau python
import pandas as pd

data = {
  'Marque': ['Honda', 'Ford', 'Mazda'],
  'Modele': ['Civic', 'F-150', 'Protege'],
  'Prix (\$)': [35000, 100000, 5000]
}
...
- [ ] Changer le nom des label de tableaux et figures. Voir: (\usepackage{caption})
